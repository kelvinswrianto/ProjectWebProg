    ...
    <div class="leftheader">
        ...
        <?php if(Session::get("login") == 1): ?>
            ...
            <?php else: ?>
                <div class="dropdown">
                    <button href="#contact" class="menu dropbtn">
                        <?php echo e(Session::get('username')); ?> Menu
                        <i class="arrow down"></i>
                    </button>
                    <div class="dropdown-content">
                        <a href="/homepage">Home Page</a>
...
<?php /**PATH D:\Kuliah\Semester 5\Web Programming\PROJECT LAB\LARAVEL\ProjectWebProg\ProjectWebProg\resources\views/layout.blade.php ENDPATH**/ ?>